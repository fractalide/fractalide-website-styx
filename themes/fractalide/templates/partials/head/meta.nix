...
in
  ''
    ...
    <meta property="og:image" content="${conf.siteUrl + "/img/roadmap-min/fractal-min.png"}" />
    <meta property="og:description" content="A dapp browser for cryptocurrencies" />
    ...
    <meta name="twitter:description" content="A dapp browser for cryptocurrencies" />
    <meta name="twitter:image" content="${conf.siteUrl + "/img/roadmap-min/fractal-min.png"}" />
