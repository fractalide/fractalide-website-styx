{ conf, lib, templates, data, pages, prefix, ... }:
{ page }:
with lib;
let
...
templates.bootstrap.navbar.default {
  id = "main-nav";
  brand = ''<a class="navbar-brand page-scroll" href="${templates.url (prefix + "/#page-top")}"><img src="${templates.url "/img/fractalide.svg"}"> FRACTALIDE</a>'';
