<div class="row">
    <div class="col-lg-offset-3 col-lg-6 col-sm-offset-2 col-sm-8 col-xs-offset-1 col-xs-10">
        <div class="text-center">
            <h2 class="sub_heading_blue">A Tezos Stake Pool has an important role in securing the XTZ cryptocurrency and being our gateway drug</h2>
            <p>
                Our Fractalide XTZ Stakepool is now live and you're welcome to put your tezzies to work by delegating them to the below address.
            </p>
            <p>
                We return 85% of our baking rewards to you. The other 15% supports the building of a new browser for a future Internet. This page is recently launched and is still undergoing updates, but the underlying service is fully operational and usable.
            </p>
        </div>
    </div>
</div>
