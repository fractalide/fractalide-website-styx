...
with lib;
{
  ...
  content = markdownToHtml ''
    ...
    * Keep the concept of cards and stack, where a good analogy is a card is a webpage and a stack is a website. Each card contains GUI components and logic that links all the other cards together to form an stack of cards.
