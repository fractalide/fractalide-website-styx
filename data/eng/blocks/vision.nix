...
with lib;
{
  ...
  content = markdownToHtml ''
    Cryptocontracts will never reach mainstream as long as we keep publishing contracts to a blockchain address and expect users to interact with that address.
