            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-offset-2 col-xs-8">
                        <div class="text-center">
                            <p class="text_white">
                                <b class="text_white">Problem:</b> A centralised app provider (website) operates behind closed doors. It can cut your service, invade your privacy and can be disabled in one hit.
                            </p>
                            <p class="text_white">
